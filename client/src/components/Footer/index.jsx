...
const Footer = () => {
  return (
    <footer className="overflow-x-hidden bg-black w-full h-auto text-base text-white font-medium">
      <div className="px-14% w-full h-full py-20">
        <div className="flex mb-20">
          <div className="mr-12">
            <span>
              <svg
                className="text-white h-10 w-132 fill-current"
                viewBox="0 0 63 20"
          ...
          <div className="flex flex-start space-x-28 pt-3 flex-1">
            <ul className="space-y-5">
              <li className="text-gray-400 text-xs">COMPANY</li>
              <li className="cursor-pointer hover:text-green_1ed760">About</li>
              <li className="cursor-pointer hover:text-green_1ed760">About</li>
              <li className="cursor-pointer hover:text-green_1ed760">
                For the Record
              </li>
            </ul>
            <ul className="space-y-5">
              <li className="text-gray-400 text-xs">COMMUNITIES</li>
              <li className="cursor-pointer hover:text-green_1ed760">
                For Artists
              </li>
              <li className="cursor-pointer hover:text-green_1ed760">
            ...
            <ul className="space-y-5">
              <li className="text-gray-400 text-xs">USEFUL LINKS</li>
              <li className="cursor-pointer hover:text-green_1ed760">
                Support
              </li>
              <li className="cursor-pointer hover:text-green_1ed760">
          ...
          <div className="flex justify-start items-start space-x-5">
            <div className="w-14 h-14 bg-gray-800 rounded-full grid place-content-center hover:text-green_1ed760">
        ...
        <div className="flex justify-end items-center text-xs mb-2 font-light">
          <span className="hover:text-green_1ed760"> USA</span>
          <svg
            width="12"
            height="13"
            viewBox="0 0 12 13"
        ...
        <div className="flex justify-between text-xs font-light text-gray-400">
          <ul className="flex justify-start items-center space-x-8">
            <li className="cursor-pointer hover:text-green_1ed760">Legal</li>
            <li className="cursor-pointer hover:text-green_1ed760">
              Privacy Center
            </li>
            <li className="cursor-pointer hover:text-green_1ed760">
