...
import { urlAuth } from "../../features/Auth/auth";

const Header = () => {
  return (
    <header className="w-full h-20 bg-black text-white overflow-x-hidden">
      <div className="flex justify-between items-center h-full mx-14%">
        <div>
          <a href="/">
            <span>
              <svg
        ...
        <div>
          <ul className="flex items-center justify-center space-x-8">
            <li className="text-base font-medium hover:text-green_1ed760">
              Premium
            </li>
            <li className="text-base font-medium hover:text-green_1ed760">
              Support
