...
const TopQueue = () => {
  return (
    <div className="flex justify-start items-center space-x-10 py-7">
      <button className="p-3 bg-green_1ed760 hover:transform hover:scale-110 rounded-full text-gray-100">
        <svg
          height="28"
          role="img"
          width="28"
